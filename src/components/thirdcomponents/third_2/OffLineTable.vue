<template>
  <div>
      <Table :columns="columns" :data="data">
        ...
        <template slot-scope="{ row, index }" slot="deviceofflinetime">
          <Input type="text" v-model="editdeviceofflinetime" v-if="editIndex === index" />
          <span v-else>{{ row.deviceofflinetime }}</span>
        </template>
      </Table>
