...
<!--        </Select>-->
<!--      </div>-->
      <Button style="margin-left: 5%" @click="renderagain">查找</Button>
<!--      <Select1>-->
...
<!--      </Select1>-->
    ...
    <div class="buttontotal">
      <div class="buttontwo">
        <router-link :to="{path:'/viewdata/xitongshangxian',query:{prov:selectProv,city:selectCity}}"><Button type="text">系统上线</Button></router-link>
        <router-link :to="{path:'/viewdata/xitongyunxing',query:{prov:selectProv,city:selectCity}}"><Button type="text" class="buttonleft">系统运行</Button></router-link>
        <router-link :to="{path:'/viewdata/shebeiyunxing',query:{prov:selectProv,city:selectCity}}"><Button type="text" class="buttonleft">设备运行</Button></router-link>
        <router-link :to="{path:'/viewdata/cpanxinxi',query:{prov:selectProv,city:selectCity}}"><Button type="text" class="buttonleft">c盘信息</Button></router-link>
      </div>
...
<script>
// import Select1 from "@/components/common/Select1";
...
export default {
  ...
  data() {
    ...
    methods: {
      renderagain() {
          this.againrender = false
          this.$nextTick(function(){
              this.againrender = true
          })
      },
        exportData() {
